...
def test_lscx(pub_data):
    method = "GET"  #请求方法，全部大写
    feature = "用户模块"  # allure报告中一级分类
    story = '查询流水'  # allure报告中二级分类
    title = "查询单个用户流水_全字段正常流_1"  # allure报告中用例名字
